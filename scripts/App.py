...
def criar_interface():
    root = tk.Tk()
    root.title("Análise de Recurso Solar")

    button_analisar0 = tk.Button(root, text="Consumo", command=consumo_resultados)
    button_analisar0.pack(pady=20)

    button_analisar1 = tk.Button(root, text="Realizar Análise", command=solar_resultados)
